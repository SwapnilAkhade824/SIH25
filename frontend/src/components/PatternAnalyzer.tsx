                ...
                <CardHeader className="pb-3">
                  <CardTitle className="flex items-center justify-between text-lg">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="font-mono text-kolam-gold">
                        DOT_COUNT
                      </span>
                    </div>
                  ...
                  <div className="space-y-3">
                    ...
                    <div className="space-y-1">
                      <div className="flex justify-between text-xs font-mono">
                        ...
                        <span className="text-white">
                          {analysisResult.symmetry.axes.join(", ")}
                        </span>
                      </div>
                      <div className="flex justify-between text-xs font-mono">
                        <span className="text-gray-400">AXIS_COUNT:</span>
                        <span className="text-white">
                          {analysisResult.symmetry.axes.length}
                        </span>
                      </div>
                    </div>
                  </div>
                ...
                <CardHeader className="pb-3">
                  <CardTitle className="flex items-center justify-between text-lg">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className="font-mono text-sacred-red">
                        COMPLEXITY
                      </span>
                    </div>
                    <div className="text-xs font-mono text-green-400">
                ...
                <div className="bg-black/50 p-4 rounded-lg font-mono text-sm border border-primary/20">
                  ...
                  <div className="mt-3 text-xs space-y-1">
                    <div className="text-gray-400">
                      ...
                      <span className="text-kolam-gold">94.7%</span>
                    </div>
                    <div className="text-gray-400">
